...
public class CucumberMovementScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(hand.transform.position.x - 12 + xOffset, transform.position.y, transform.position.z);
    }
